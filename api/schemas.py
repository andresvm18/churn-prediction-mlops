...
class CustomerData(BaseModel):
    ...
    online_security: Literal["Yes", "No", "No internet service"]   # Online security add-on
    online_backup: Literal["Yes", "No", "No internet service"]     # Online backup add-on
    device_protection: Literal["Yes", "No", "No internet service"] # Device protection add-on
    ...
    streaming_movies: Literal["Yes", "No", "No internet service"]   # Movies streaming add-on
